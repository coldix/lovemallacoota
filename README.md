...
[![Site Version](https://img.shields.io/badge/version-v1.86-0284c7.svg)](data/site-version.json)
[![Build & Test](https://img.shields.io/badge/tests-160%20passing-22c55e.svg)](tests/)

<!-- version -->
**v1.86** - built 16 September 2026.
<!-- /version -->

Both the line above and the version badge are written by
`tools/update-version.mjs`, so `pnpm run version:site` keeps them true. Do not
edit them by hand.
